...
public class Player : MonoBehaviour
{
    ...
    void Movement()
    {
        ...
        {
            transform.position = new Vector3(transform.position.x, transform.position.y * -.001f, 0);
        }

        if (transform.position.y <= verticalScreenLimit - 4)
        {
            transform.position = new Vector3(transform.position.x, transform.position.y * -.001f - 3, 0);
        }
    }
